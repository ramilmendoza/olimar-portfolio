...
const Navbar = () => {
  ...
  const renderNavLinks = (isSecondary) => (
    <ul className={`list-none ${isSecondary ? 'flex sm:hidden' : 'hidden sm:flex'} flex-row gap-6 font-futuristic`}>
      {navLinks.map((link) => (
        <li
          key={link.id}
          className={`${
      ...
      >
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-white text-[20px] font-bold cursor-pointer flex font-futuristic">
              RAMILO MENDOZA&nbsp;
